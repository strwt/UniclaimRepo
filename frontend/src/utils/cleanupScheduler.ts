...
export class CleanupScheduler {
    ...
    public start(): void {
        ...
        console.log('🕐 Starting automatic cleanup scheduler (runs every hour)');
    ...
    public stop(): void {
        if (!this.isRunning) {
            console.log('🕐 Cleanup scheduler not running');
            return;
        }

        console.log('🕐 Stopping automatic cleanup scheduler');
    ...
    private async runCleanup(): Promise<void> {
        try {
            ...
            if (result.success) {
                console.log(`🕐 Scheduled cleanup completed: ${result.conversationsDeleted} conversations deleted`);
            } else {
                console.warn(`🕐 Scheduled cleanup completed with errors:`, result.errors);
            }
        } catch (error: any) {
    ...
    public async forceCleanup(): Promise<void> {
        console.log('🕐 Force cleanup triggered by scheduler');
